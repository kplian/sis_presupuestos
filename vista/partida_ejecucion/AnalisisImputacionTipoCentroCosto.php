...
?>
<script>
Phx.vista.AnalisisImputacionTipoCentroCosto=Ext.extend(Phx.gridInterfaz,{
	...
	constructor:function(config){
		...
		Phx.vista.AnalisisImputacionTipoCentroCosto.superclass.constructor.call(this,config);
	...
	ActList:'../../sis_presupuestos/control/PartidaEjecucion/AnalisisImputacionTipoCentroCosto',
	id_store:'id_tipo_cc',
	fields: [
    ...
    south: {
        url: '../../../sis_presupuestos/vista/partida/AnalisisImputacionPartida.php',
        title: 'Partida',
        //width: '70%',
        height:'40%',
        cls: 'AnalisisImputacionPartida'
    },

	loadValoresIniciales:function(){
		Phx.vista.AnalisisImputacionTipoCentroCosto.superclass.loadValoresIniciales.call(this);
