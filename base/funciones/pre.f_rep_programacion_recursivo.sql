...
CREATE OR REPLACE FUNCTION pre.f_rep_programacion_recursivo (
                       ...
                       insert into temp_prog(
                               ...
                               values   (
                                ...
                                update temp_prog set
                                   procesado = 'si'
                                where  id_partida_fk = v_registros.id_partida_fk;
          
          END LOOP;
          
          -- si tenemos mas datos para procesar hacemos la llamada recursiva
          IF v_sw_force THEN
               PERFORM pre.f_rep_programacion_recursivo(p_id_gestion);
          END IF;
