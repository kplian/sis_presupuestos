...
/**************************************************************************
 ...
 DESCRIPCION:   Funcion que devuelve conjuntos de registros de las consultas relacionadas con la tabla 'pre.tcp_proyecto'
 AUTOR: 		 (admin)
...
BEGIN
	...
	v_nombre_funcion = 'pre.ft_cp_proyecto_sel';
	...
	***********************************/
		...
		begin
			...
			v_consulta:='select count(id_cp_proyecto)
					    from pre.tcp_proyecto cppr
					    inner join segu.tusuario usu1 on usu1.id_usuario = cppr.id_usuario_reg
						left join segu.tusuario usu2 on usu2.id_usuario = cppr.id_usuario_mod
					    where ';
