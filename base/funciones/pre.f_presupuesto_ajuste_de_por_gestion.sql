CREATE OR REPLACE FUNCTION pre.f_presupuesto_ajuste_de_por_gestion (
...
DECLARE
   v_resp							varchar;
     ...
     v_total						numeric;
BEGIN
 v_nombre_funcion:='pre.f_presupuesto_ajuste_de_por_gestion';

 select 	COALESCE(d.importe,0)
            into
            v_total
...
where 	d.id_partida = p_id_partida
        ...
        and (a.tipo_ajuste !='decremento_formulacion'
        and a.tipo_ajuste !='incremento_formulacion')
