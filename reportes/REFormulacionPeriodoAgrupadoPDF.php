...
class REFormulacionPeriodoAgrupadoPDF extends  ReportePDF {
	var $datos_titulo;
	var $datos_detalle;
	var $ancho_hoja;
	var $gerencia;
   ...
   function generarReporte() {
	...
	function imprimirLinea($val,$count,$fill){
		...
		$RowArray = array(
					's0'  => trim($val['partida']),
					's2' => $val['enero'],
					's3' => number_format($val['febrero'],2,",","."),
					's4' => number_format($val['marzo'],2,",",".") ,
					's5' => number_format($val['abril'],2,",",".") ,
  ...
  function cerrarCuadroTotal(){
    ...
    $conf_tabletextcolor=array(array(255, 255, 255),array(255, 255, 255),array(255, 255, 255),array(255, 255, 255),array(255, 255, 255),array(255, 255, 255),array(255, 255, 255),array(255, 255, 255),array(255, 255, 255),array(255, 255, 255),array(255, 255, 255),array(255, 255, 255),array(255, 255, 255),array(255, 255, 255));
    $this->tabletextcolor=$conf_tabletextcolor;
